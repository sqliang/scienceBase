	                        ...
	                        <div class="col-md-12">
	                        	<form action="addNewsinfo" method="post">
	                        		<div class="form-group">
    									...
    									<input type="text" name="newsinfo.newstitle" class="form-control" id="newsTitle" placeholder="输入标题">
  									</div>
  									<div class="form-group">
    									<label for="author">作者：</label>
    									<input type="text" name="newsinfo.author" class="form-control" id="author" placeholder="输入作者">
  									</div>
  									<div class="form-group">
    									...
    									<select class="form-control" name="newsinfo.newstype" style="display: inline-block;width: 120px; background: transparent;">
										    ...
										    <option value="3">学术报告</option>
										    <option value="4">学术动态</option>
										</select>
  									</div>
  									<div class="form-group">
