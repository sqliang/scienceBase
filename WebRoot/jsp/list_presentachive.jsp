				...
				<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th style="font-weight:bold;text-align:center;">成果名称</th>
									<th style="font-weight:bold;text-align:center;">成果类型</th>
									<th style="font-weight:bold;text-align:center;">成果简介</th>
								</tr>
							</thead>
							<tbody>
                    	<c:forEach varStatus="status" var="presentachiveinfo" items="${presentachiveinfos}">
							 <tr>
							 	<td style="text-align:center;">${status.index + 1}</td>
								<td style="text-align:center;">${presentachiveinfo.presentachivetitle}</td>
								<td style="text-align:center;">${presentachiveinfo.presentachivetype}</td>
								<td style="text-align:center;">${presentachiveinfo.presentachivecontent}</td>
							 </tr>
                    	</c:forEach>
							</tbody>
						</table>
