					...
					<c:forEach var="paperinfo" items="${paperinfos}">
						<li class="class-list proj-list">
			                 <div class="leader-list">
			                 	<span class="label-title">论文题目：</span>
			                     <span>${paperinfo.papername}</span>
			                  </div>
			                 <div class="leader-list">
			                 	<span class="label-title">论文作者：</span>
			                    <span>${paperinfo.paperauthor}</span>
			                  </div>
			                  <div class="leader-list">
			                   	<span class="label-title">期刊名称：</span>
			                    <span>${paperinfo.paperjounal}</span>
			                  </div>
			                  <div class="leader-list">
			                    <span class="label-title">期刊信息：</span>
			                    <span>${paperinfo.journalinfo}</span>
			                  </div>
			                  <div class="leader-list">
			                    <span class="label-title">论文收录情况：</span>
			                    <span>${paperinfo.paperinclude}</span>
			                  </div>
		          		</li>				
                    </c:forEach>
				</ul>
