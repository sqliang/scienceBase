	                        ...
	                        <div class="col-md-12">
	                        	<form action="addIntrInfo" method="POST">
	                        		<div class="form-group">
    									...
    									<input type="text" name="introduceinfo.arttitle" class="form-control" id="newsTitle" placeholder="输入标题">
  									</div>
  									<div class="form-group">
    									<label for="author">作者：</label>
    									<input type="text" name="introduceinfo.author" class="form-control" id="author" placeholder="输入作者">
  									</div>
  									<div class="form-group">
    									...
    									<select class="form-control" name="introduceinfo.arttype" style="display: inline-block;width: 140px; background: transparent;">
											<option value="1">实验室简介</option>
										    <option value="2">队伍概况</option>
										    <option value="3">人才培养概况</option>
										    <option value="4">科学研究概况</option>
										</select>
  									</div>
  									<div class="form-group">
						                ...
						                <!-- 加载编辑器的容器 -->
									    <script id="content" name="introduceinfo.content" type="text/plain">请输入内容</script>
						            </div>
						             <div class="form-group">
