					...
					<c:forEach var="presentachiveinfo" items="${presentachiveinfos}">
						<li class="class-list paptent-list">
			                 <div class="leader-list">
			                 	<span class="label-title">成果名称：</span>
			                     <span>${presentachiveinfo.presentachivetitle}</span>
			                  </div>
			                 <div class="leader-list">
			                 	<span class="label-title">成果类型：</span>
			                    <span>${presentachiveinfo.presentachivetype}</span>
			                  </div>
			                  <div class="leader-list">
			                    <span class="label-title">成果简介：</span>
			                    <span>${presentachiveinfo.presentachivecontent}</span>
			                  </div>
		          		</li>				
                    </c:forEach>
				</ul>
